...
- PostgreSQL v16/v17 继续追加 M1—M3 S1-S6 与向量 metadata，v18—v22 追加模型
  调用审计、等待队列、重评操作和动态班级名单冻结，均不修改 M6 表；
  SQLite platform ledger 为 v21，M1—M3 SQLite 仓储使用独立 version 1 ledger。
