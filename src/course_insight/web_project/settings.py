...
COURSE_INSIGHT_KNOWLEDGE_STORAGE_DIR = (
    PLATFORM_SETTINGS.runtime_dir / "knowledge_uploads"
)
COURSE_INSIGHT_INGESTION_STATUS_DIR = (
    PLATFORM_SETTINGS.runtime_dir / "ingestion_worker"
)
...
COURSE_INSIGHT_MAX_REQUEST_BODY_BYTES = (
    PLATFORM_SETTINGS.security.max_request_body_bytes
)
COURSE_INSIGHT_MAX_UPLOAD_REQUEST_BODY_BYTES = (
    PLATFORM_SETTINGS.security.max_upload_request_body_bytes
)
DATA_UPLOAD_MAX_MEMORY_SIZE = 8 * 1024**2
FILE_UPLOAD_MAX_MEMORY_SIZE = 8 * 1024**2
